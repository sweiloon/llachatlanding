...
/* ─── Liquid Glass Card with gyroscope tilt (outer div wrapper) ─── */
...
function CircularProgress({ label }: { label: string }) {
  ...
  return (
    <div ref={ref} className="relative w-28 h-28 sm:w-36 sm:h-36">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        ...
        <span className="text-[10px] text-white/25 font-mono mt-0.5">{label}</span>
      </div>
    </div>
  );
}
    ...
    <section id="features" className="relative z-10 py-8 sm:py-11 md:py-16 px-5 sm:px-8">
      ...
      <div className="max-w-6xl mx-auto">
        <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="flex items-center gap-3 mb-4">
          <span className="font-mono text-[10px] text-[#a78bfa]/30 tracking-[0.3em] uppercase">{t.features.num}</span>
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-6 sm:gap-8 md:gap-12">
              <div className="flex-1">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#a78bfa]/[0.06] border border-[#a78bfa]/[0.1] mb-4 backdrop-blur-sm">
                  ...
                  <span className="font-mono text-[9px] text-[#a78bfa]/50 tracking-[0.15em] uppercase">{t.features.coreBadge}</span>
                </div>
                <h3 className="font-heading text-2xl sm:text-3xl md:text-4xl font-bold text-white tracking-tight mb-3 sm:mb-4">{t.features.f1Title}</h3>
                <p className="text-white/30 text-sm sm:text-base leading-relaxed max-w-lg mb-5 sm:mb-6">{t.features.f1Desc}</p>
                <div className="flex gap-6 sm:gap-8">
                  {t.features.f1Stats.map((s) => (
                    <div key={s.lab}>
              ...
              <div className="flex justify-center md:justify-end"><CircularProgress label="TRUST %" /></div>
            </div>
...
└───────────────────────┘`}
        ...
        {/* Feature bento grid — 6-col for symmetric rows on desktop */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 sm:gap-5">
          {/* Row 1: 3 equal cards (each 2/6 = 1/3) */}
            ...
            <GradientBorderCard delay={0.08} tilt={tilt}>
              <div className="relative p-5 sm:p-6 md:p-7 h-full">
                ...
                <div className="relative z-10 h-full flex flex-col">
                  ...
                  <h3 className="font-heading text-base sm:text-lg font-bold text-white mb-1.5 group-hover:text-[#a78bfa]/80 transition-colors duration-500 tracking-tight">{t.features.f2Title}</h3>
                  <p className="text-[11px] sm:text-xs text-white/20 leading-relaxed flex-1 group-hover:text-white/30 transition-colors duration-500">{t.features.f2Desc}</p>
                </div>
              </div>
            </GradientBorderCard>
          </div>
            ...
            <GradientBorderCard delay={0.14} tilt={tilt}>
              <div className="relative p-5 sm:p-6 md:p-7 h-full">
                ...
                <div className="relative z-10 h-full flex flex-col">
                  ...
                  <h3 className="font-heading text-base sm:text-lg font-bold text-white mb-1.5 group-hover:text-[#a78bfa]/80 transition-colors duration-500 tracking-tight">{t.features.f3Title}</h3>
                  <p className="text-[11px] sm:text-xs text-white/20 leading-relaxed flex-1 group-hover:text-white/30 transition-colors duration-500">{t.features.f3Desc}</p>
                </div>
              </div>
            </GradientBorderCard>
          </div>
            ...
            <GradientBorderCard delay={0.2} tilt={tilt}>
              <div className="relative p-5 sm:p-6 md:p-7 h-full">
                ...
                <div className="relative z-10 h-full flex flex-col">
                  ...
                  <h3 className="font-heading text-base sm:text-lg font-bold text-white mb-1.5 group-hover:text-[#a78bfa]/80 transition-colors duration-500 tracking-tight">{t.features.f4Title}</h3>
                  <p className="text-[11px] sm:text-xs text-white/20 leading-relaxed flex-1 group-hover:text-white/30 transition-colors duration-500">{t.features.f4Desc}</p>
                </div>
              </div>
            </GradientBorderCard>
          </div>

          {/* Row 2: 2 equal cards (each 3/6 = 1/2) */}
          <div className="lg:col-span-3">
            <GradientBorderCard delay={0.26} tilt={tilt}>
              <div className="relative p-5 sm:p-6 md:p-7 h-full">
                ...
                <div className="relative z-10 h-full flex flex-col">
                  ...
                  <h3 className="font-heading text-base sm:text-lg font-bold text-white mb-1.5 group-hover:text-[#a78bfa]/80 transition-colors duration-500 tracking-tight">{t.features.f5Title}</h3>
                  <p className="text-[11px] sm:text-xs text-white/20 leading-relaxed flex-1 group-hover:text-white/30 transition-colors duration-500">{t.features.f5Desc}</p>
                </div>
              </div>
            </GradientBorderCard>
          </div>
          ...
          <div className="lg:col-span-3">
            <GradientBorderCard delay={0.32} tilt={tilt}>
              <div className="relative p-5 sm:p-6 md:p-7 h-full">
