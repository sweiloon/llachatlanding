    ...
    <div ref={ref} className="relative w-28 h-28 sm:w-36 sm:h-36">
      <svg viewBox="0 0 100 100" className="w-full h-full -rotate-90">
        ...
        <motion.circle
          ...
          animate={isInView ? { strokeDashoffset: c * 0.03 } : {}}
  ...
  return (
    <div className="relative w-14 h-8 sm:w-16 sm:h-10">
      <svg viewBox="0 0 80 40" className="w-full h-full" fill="none">
        <motion.path
          d="M20 20c0-8 8-15 16-15s16 7 16 15-8 15-16 15-16-7-16-15zm24 0c0-8 8-15 16-15s16 7 16 15-8 15-16 15-16-7-16-15z"
          stroke="url(#infGrad)"
          strokeWidth="2"
          strokeLinecap="round"
  ...
  return (
    <section id="features" className="relative z-10 py-16 sm:py-24 md:py-32 px-5 sm:px-8">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {/* ── Hero feature card ── */}
        <GradientBorderCard className="mb-4 sm:mb-5" delay={0}>
          <div className="relative p-6 sm:p-8 md:p-10 overflow-hidden">
            {/* BG watermark */}
            <div className="absolute top-4 right-4 sm:top-6 sm:right-8 font-heading text-[80px] sm:text-[120px] md:text-[160px] font-extrabold text-white/[0.015] leading-none select-none pointer-events-none">
              01
            </div>
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-6 sm:gap-8 md:gap-12">
              ...
              <div className="flex-1">
                ...
                <p className="text-white/30 text-sm sm:text-base leading-relaxed max-w-lg mb-5 sm:mb-6">
                  Our proprietary model passes the conversational Turing test. Blind testers consistently rate our AI as human.
                  Natural pauses, humor, empathy — all learned from millions of real conversations.
                </p>
...
└───────────────────────┘`}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
            ...
            <div className="relative p-5 sm:p-6 md:p-7 h-full">
              ...
              <div className="relative z-10 h-full flex flex-col">
                ...
                <p className="text-[11px] sm:text-xs text-white/20 leading-relaxed flex-1 group-hover:text-white/30 transition-colors duration-500">
                  Detects sentiment shifts in real-time. Adjusts tone, pacing, and vocabulary like a real person would.
                </p>
              </div>
            </div>
          </GradientBorderCard>
              ...
              <div className="relative z-10 h-full flex flex-col">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <motion.div
                    animate={{ y: [0, -4, 0] }}
                    transition={{ repeat: Infinity, duration: 2.5, ease: 'easeInOut' }}
                    className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[#25D366]/10 border border-[#25D366]/15 flex items-center justify-center"
                  >
                ...
                <p className="text-[11px] sm:text-xs text-white/20 leading-relaxed flex-1 group-hover:text-white/30 transition-colors duration-500">
                  Deployed directly on WhatsApp — zero downloads, zero friction. Meet customers where they are.
                </p>
              </div>
            </div>
          </GradientBorderCard>
          ...
          <GradientBorderCard delay={0.2}>
            <div className="relative p-5 sm:p-6 md:p-7 h-full">
              ...
              <div className="relative z-10 h-full flex flex-col">
                ...
                <p className="text-[11px] sm:text-xs text-white/20 leading-relaxed flex-1 group-hover:text-white/30 transition-colors duration-500">
                  Customer service, sales, healthcare, luxury — domain-trained for any industry.
                </p>
              </div>
            </div>
          </GradientBorderCard>
          ...
          {/* Self-Evolving */}
          <GradientBorderCard delay={0.26} className="sm:col-span-1 lg:col-span-1">
            <div className="relative p-5 sm:p-6 md:p-7 h-full">
              ...
              <div className="relative z-10 h-full flex flex-col">
                ...
                <p className="text-[11px] sm:text-xs text-white/20 leading-relaxed flex-1 group-hover:text-white/30 transition-colors duration-500">
                  Gets smarter with every conversation. Continuously learning and adapting.
                </p>
              </div>
            </div>
          </GradientBorderCard>

          {/* Enterprise Secure — wide */}
          <GradientBorderCard delay={0.32} className="sm:col-span-2">
